      ...
      <div className="dashboard-grid">
        <article id="overview" className="dashboard-card dashboard-card--hero">
          ...
          <p className="auth-helper">
            This workspace follows confidentiality-first defaults: role-limited visibility, masked contacts,
            and secure actions.
          </p>
        ...
        {role === 'admin' && (
          <>
            ...
            <article id="role-actions" className="dashboard-card">
              ...
              <div className="dashboard-actions">
                <Link className="btn btn-primary" to="/dashboard/admin-role-management">
